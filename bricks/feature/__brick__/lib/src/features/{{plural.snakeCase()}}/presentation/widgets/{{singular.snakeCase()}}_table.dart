...
import 'package:{{packageName.snakeCase()}}/src/features/{{plural.snakeCase()}}/domain/{{singular.snakeCase()}}_table_key.dart';
...
class {{singular.pascalCase()}}Table extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tableKey = {{singular.pascalCase()}}TableKey.key();
