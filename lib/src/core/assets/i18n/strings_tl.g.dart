...
class _TranslationsCommonTl implements TranslationsCommonEn {
	...
	// Translations
	@override String get appName => 'Mason Sampler';
	@override String get placeholderText => '-';
}
...
extension on TranslationsTl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'common.appName': return 'Mason Sampler';
			case 'common.placeholderText': return '-';
			default: return null;
		}
	}
}
