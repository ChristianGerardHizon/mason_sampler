...
import 'package:mason_sampler/src/features/admins/presentation/pages/_index.dart';
import 'package:mason_sampler/src/features/customers/presentation/pages/_index.dart';
...
import 'package:mason_sampler/src/core/widgets/app_root.dart';

part 'main.routes.g.dart';
part 'routes/admins.routes.dart';
part 'routes/customers.routes.dart';
part 'routes/branches.routes.dart';
part 'routes/auths.routes.dart';
