...
abstract class _$AdminController
  ...
  FutureOr<Admin> build(String id);
}
...
class AdminControllerFamily extends Family<AsyncValue<Admin>> {
  ...
  /// See also [AdminController].
  AdminControllerProvider call(String id) {
    return AdminControllerProvider(id);
  }
...
class AdminControllerProvider
  ...
  /// See also [AdminController].
  AdminControllerProvider(String id)
    : this._internal(
  ...
  @override
  FutureOr<Admin> runNotifierBuild(covariant AdminController notifier) {
